...
def array_nator_400(grid):
    numbers = grid.split()
    Array   = [[numbers.pop(0) for j in range(20)] for i in range(20)] # Takes out the first 20 items and put them into a row, then repeat.

    return Array

def great_product(Array):
    Biggest_Product = 0
...
print(great_product(array_nator_400(grid_in_text)))